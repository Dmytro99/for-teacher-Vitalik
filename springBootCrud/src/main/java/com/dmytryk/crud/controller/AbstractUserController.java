...
//  @GetMapping
//  public abstract Resources<UserModel> getUsers();
//
//  @ApiOperation(value = "Returns a specific user by user Id")
//  @ResponseStatus(HttpStatus.OK)
//  @GetMapping(value = "/{id}")
//  public abstract UserModel getUserById(@PathVariable("id") String id);
//
//  @ApiOperation(value = "Add new user to the list of users")
//  @PostMapping
//  public abstract ResponseEntity<UserModel> postUser(@RequestBody @Valid UserDto userDto);
//
